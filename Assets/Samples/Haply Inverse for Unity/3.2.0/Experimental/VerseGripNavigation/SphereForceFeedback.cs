...
namespace Haply.Samples.Experimental.VerseGripNavigation
{
    public class SphereForceFeedback : MonoBehaviour
    {
        ...
        private void OnDeviceStateChanged(object sender, Inverse3EventArgs args)
        {
            ...
            // ensures the force calculation considers the device's offset and scaling in world space.
            var force = ForceCalculation(inverse3.CursorPosition, inverse3.CursorVelocity, sceneData.cursorRadius,
