...
namespace Haply.Samples.Tutorials._5_SimplePositionControl
{
    ...
    public class SpherePositionControl : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            inverse3.Ready.AddListener((device, args) =>
            {
                ...
                _movableObject.SetTargetPosition(device.WorkspaceCenterLocalPosition, teleport:true);
            });
        }
        ...
        private void FixedUpdate()
        {
            if (_isCursorSynchronized)
            {
                ...
                inverse3.SetCursorPosition(transform.position);
            }
            else if (inverse3.IsReady)
            {
                inverse3.ProbeCursorPosition();
            }
        }
        ...
        private void StartSynchronizeCursor()
        {
            ...
            _movableObject.SetTargetPosition(cursorPosition, teleport:true);
